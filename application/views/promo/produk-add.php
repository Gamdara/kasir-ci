      ...
      <div class="card">
        ...
        <div class="row">
          ...
          <form action="<?php echo site_url('promo/add') ?>" method="post">
            <input type="hidden" name="kategori" value="perproduk">
            ...
            <div class="form-group">
              ...
              <textarea name="deskripsi" class="form-control col-sm-6" cols="30" rows="10"></textarea>
              ...
              <ul class="nav nav-treeview">
                ...
                <li class="nav-item"> -->
                  <div class="form-group">
                    ...
                    <input type="number" name="potongan"  class="form-control col-sm-6" placeholder="Nilai Potongan" id="potongan">
            ...
            <div class="form-group">
              ...
              <input type="text" value="0" class="form-control col-sm-6" placeholder="Minimal Pembelian" id="min_beli" name="min_beli">
