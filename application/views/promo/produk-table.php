     ...
     <section class="content">
      <div class="container-fluid">
        <div class="card">
          ...
          <a href="<?= base_url('promo/addproduk/'); ?>"><button class="btn btn-success">Add</button></a>
          </div>
          <div class="card-body">
...
<script>
  const readUrl = '<?= base_url('promo/read/perproduk') ?>'
</script>
<script >
    ...
    columns: [
        ...
        { 
          render: function ( data, type, full, meta ) {
            return `
              <a href=<?= base_url('promo/editproduk/') ?>${full.id} class="btn btn-success" role="button">Edit</a>
